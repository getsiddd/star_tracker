...
public:
    ...
    CatalogStar(float raj2000, float dej2000, int magnitude, int name) :
        spatial(SphericalToSpatial(raj2000, dej2000)), magnitude(magnitude), name(name), ra(raj2000), dec(dej2000) {}
    ...
    Vec3 spatial;
    /**
     * The magnitude of the star, with the float point shifted two places right.
...
public:
    ...
    StarIdentifier(int starIndex, int catalogIndex)
        : StarIdentifier(starIndex, catalogIndex, 1.0) { };
