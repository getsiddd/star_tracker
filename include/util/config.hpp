...
#ifndef LOST_CONFIG_HPP_
#define LOST_CONFIG_HPP_
...
namespace lost {
	namespace util {
		...
		const std::string PROPERTY_LOST_SERVER_PORT = "lost_server_port";
		//const std::string PROPERTY_LOST_SERVER_DIR = "lost_server_path";
